...
### Restreindre l'accès au réseau d'un container

```bash
PS C:\Users\vdepa\Documents\2024-2025\container_security-\monprojet> docker run --rm --network none alpine ping -c 3 google.com
>>
ping: bad address 'google.com'

``` 
Ici on n'a juste pas attribuer de réseau au container
